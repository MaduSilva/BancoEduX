...
CREATE TABLE Postagem(
	...
	--Fk
	IdUsuario  UNIQUEIDENTIFIER  FOREIGN KEY REFERENCES Usuario (IdUsuario),
	IdCurtida UNIQUEIDENTIFIER  FOREIGN KEY REFERENCES Curtida (IdCurtida),
);

CREATE TABLE Ranking(
	IdRanking UNIQUEIDENTIFIER  PRIMARY KEY NOT NULL DEFAULT NEWID(),
	Posicao VARCHAR(255),
	QuantidadeTotal  VARCHAR(255),
	Descricao VARCHAR(255),
